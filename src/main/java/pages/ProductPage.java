...
public class ProductPage extends BasePage {
    ...
    public void validateTitle(String expectedTitle) {
        this.checkElementTitle(pageTitleElement, expectedTitle);
    }

    public void sortItems(String sortedValue) {
        this.selectDropdown(sortItemsDropdown, sortedValue);
    }
    ...
    public void validateAddedItems(String numberOfItems) {
        this.checkElementTitle(shoppingCartElement, numberOfItems);
